...
import com.tmall.wireless.tac.biz.processor.chaohaotou.enums.LogicalArea;
...
public class TairUtil {
    ...
    public List<ColumnCenterDataSetItemRuleDTO> getOriginalRecommend(Long smAreaId) {
        ...
        if (com.ali.unit.rule.util.lang.CollectionUtils.isEmpty(pmtRuleDataItemRuleDTOS)) {
            ...
            try {
                com.tmall.wireless.tac.biz.processor.chaohaotou.model.PmtRuleDataItemRuleDTO pmtRuleDataItemRuleDTO = JSON
                    .parseObject(
                        JSON.toJSON(pmtRuleDataItemRuleDTOS.get(0)).toString(),
                        com.tmall.wireless.tac.biz.processor.chaohaotou.model.PmtRuleDataItemRuleDTO.class);
