...
import com.tmall.wireless.tac.biz.processor.AppColaBootstrap;
...
@Component
public class CommonItemRecommendHandler extends RpmReactiveHandler<SgFrameworkResponse<EntityVO>> {
