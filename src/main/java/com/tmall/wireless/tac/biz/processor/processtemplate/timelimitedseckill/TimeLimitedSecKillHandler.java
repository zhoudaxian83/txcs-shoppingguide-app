...
public class TimeLimitedSecKillHandler extends TacReactiveHandler4Ald {
    ...
    public Flowable<TacResult<List<GeneralItem>>> executeFlowable(RequestContext4Ald requestContext4Ald) throws Exception {
        ...
        RecommendResponseEntity<RecommendContentEntityDTO> recommendResponse = recommendService.recommendContent(21557L, context, params);
        tacLogger.warn("recommendResponse" + JSON.toJSONString(recommendResponse));
